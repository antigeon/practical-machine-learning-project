...
validationset<-training[-subsamples,]
...
pred_lda<-predict(model_lda,validationset)
pred_qda<-predict(model_qda,validationset)
confusionMatrix(validationset$classe,pred_rf)$overall[1]
confusionMatrix(validationset$classe,pred_qda[[1]])$overall[1]
confusionMatrix(validationset$classe,pred_lda[[1]])$overall[1]
